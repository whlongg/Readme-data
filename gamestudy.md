Tuyệt vời! Tôi sẽ viết lại toàn bộ bản thiết kế, bao gồm tất cả các chi tiết và cập nhật cơ chế tính XP cho quest tùy chỉnh dựa trên thời gian thực hiện (0.2 XP/phút).
